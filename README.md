...
Today, I am building a practical Data/BI profile with a strong focus on the Microsoft Data Stack, SQL, Python, API-based data workflows and process-oriented analytics.
...
| Analytics | Python, pandas, data cleaning, automation, analysis |
| API & Data Workflows | REST APIs, JSON data, reproducible data collection |
...
- Small, testable API and data-processing steps
...
REST APIs · JSON · CSV · reproducible data collection · documented transformation steps
...
- A small Python/API project that ranks selected German cities by current weather data: [open-meteo-germany-weather-ranking](https://github.com/DataTideHH/open-meteo-germany-weather-ranking)
